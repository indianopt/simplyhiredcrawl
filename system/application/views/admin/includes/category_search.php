<script type="text/javascript">
	function clear_form() {
		...
		document.getElementsByName('type')[0].options.selectedIndex = 0;
	}
</script>
<!-- Search form -->
<ul class="tablist">
...
<form name='search_form' method="post" action="<?=site_url('admin/category/search')?>">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap>
							Title:</span>&nbsp;&nbsp;<input type="text" size="30" name="name" class="dataField" value="<?=isset($category_search_params['name']) ? $category_search_params['name'] : ''?>">
                            &nbsp;&nbsp;&nbsp;&nbsp;Type:&nbsp;&nbsp;
                            <?=category_types_dropdown(isset($category_search_params['type']) ? $category_search_params['type'] : '', 'name="type"')?>
						</td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td nowrap style="padding-top: 10px;"">
			<h3><img src="<?=base_url()?>/images/admin/h3Arrow.gif" width="11" height="11" border="0" />&nbsp;Categories</h3>
		</td>
