...
<form name='search_form' method="post" action="<?=site_url('admin/manufacturer/search')?>">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap>
							Title:</span>&nbsp;&nbsp;<input type="text" size="30" name="name" class="dataField" value="<?=isset($news_search_params['name']) ? $news_search_params['name'] : ''?>">
						</td>
