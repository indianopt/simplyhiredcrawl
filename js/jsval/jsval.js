...
return regex;
else if((retype.toUpperCase()=="STRING")&&!(regex=="JSVAL_RX_EMAIL")&&!(regex=="JSVAL_RX_TEL")&&!(regex=="JSVAL_RX_INT")&&!(regex=="JSVAL_RX_MONEY")
...
switch(regx){
case "JSVAL_RX_MONEY":
return((/([0-9]+|[0-9]{1,3}(,[0-9]{3})*)(\.[0-9]{1,2})?/).test(value));
case "JSVAL_RX_DATE":
